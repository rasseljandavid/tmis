...
class mysql_database {
	 ...
	 * @return array
	 */
	function selectObjects($table, $where = null,$orderby = null,$limit=null) {
	    ...
	    $res = @mysql_query("SELECT * FROM `" . $this->prefix . "$table` WHERE $where $orderby $limit",$this->connection);
