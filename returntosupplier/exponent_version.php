...
if (!defined('EXPONENT_VERSION_MAJOR')) {
	...
	if (RELEASE != '%%RELEASE%%') {
		...
		/* exdoc
		 * This is the major version number of Tienda; the 1 in 1.96.2-beta3
		 */
		define('EXPONENT_VERSION_MAJOR','2');
		/* exdoc
		 * This is the minor version number of Tienda; the 96 in 1.96.2-beta3
		 */
		define('EXPONENT_VERSION_MINOR','2');
		/* exdoc
		 * This is the revision version number of Tienda; the 2 in 1.96.2-beta3
		 */
		...
		/* exdoc
		 * This is the date that this version of Tienda was released.
		 */
		define('EXPONENT_VERSION_BUILDDATE','1379345833');
	} else {
