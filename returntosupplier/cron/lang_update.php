...
/**
 * lang_update.php - attempts to auto-update all TiendaCMS language files
 * by running the other two language scripts lang_extract.php & lang_translate.php
 */

output("Updating the Tienda Language System!\n");
...
print "\nCompleted Updating the Tienda Language System!\n";
