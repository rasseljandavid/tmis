...
?>
<h1><?php echo gt('Welcome to Tienda CMS'); ?></h1>
<p>
    <?php echo gt('The Tienda Development Team would like to thank you for downloading and installing the Tienda Content Management System.') .
        gt('We fervently hope that you will enjoy the power, flexibility, and ease-of-use that Tienda has to offer.') ?>
</p>

<h1 id="subtitle"><?php echo gt('Please select a language'); ?></h1>
<p>
    <?php echo gt('This will set the default Language for the installation process as well as your new Tienda website.'); ?>
</p>
