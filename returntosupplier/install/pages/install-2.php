...
<form method="post" action="index.php">
	...
	<div class="control">
		...
		<div class="control_help">
			<?php echo gt('Select which database server software package your web server is running.  If the software is not listed, it is not supported by Tienda.'); ?>
			<br /><br />
	...
	<div class="control" id="mysql_options">
		...
		<div class="control">
			...
			<div class="control_help">
				<?php echo gt('All database server software supported by Tienda require some sort of authentication.  Enter the name of the user account to use for logging into the database server.'); ?>
				<br /><br />
		...
		<div class="control">
			...
			<div class="control_help">
				<?php echo gt('Enter the password for the username you entered above.  The password will').'<strong>'.gt('not').'</strong>'.gt('be obscured, because it cannot be obscured in the configuration file.  The Tienda developers urge you to use a completely new password, unlike any of your others, for security reasons.'); ?>
			</div>
		</div>
		<div class="control">
			...
			<div class="control_help">
				<?php echo gt('A table prefix helps Tienda differentiate tables for this site from other tables that may already exist (or eventually be created by other scripts).  If you are using an existing database, you may want to change this.'); ?>
				<br /><br />
				<?php echo '<strong>'.gt('Note').':</strong>'.gt('A table prefix may only contain numbers and letters.  Spaces and symbols (including \'_\') are not allowed.  An underscore will be added for you, by Tienda.'); ?>
			</div>
		</div>
	</div>
