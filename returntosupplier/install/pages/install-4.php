...
<div id="tab1">
  ...
  <div class="text-control control  ">
    ...
    <input type="text" name="sc[ORGANIZATION_NAME]" value="Tienda CMS" size="40" class="text ">
  </div>
  <div class="text-control control  ">
    <label class="label"><?php echo gt('Site Title'); ?></label>
    <input type="text" name="sc[SITE_TITLE]" value="Tienda CMS - A Powerful, Flexible, and Intuitive Web Solution." size="40" class="text ">
  </div>
  
  <div class="text-control control ">
    <label class="label"><?php echo gt('Site Header'); ?></label>
    <input type="text" name="sc[SITE_HEADER]" value="Tienda CMS" size="40" class="text ">
  </div>
