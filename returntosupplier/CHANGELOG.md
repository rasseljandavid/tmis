...
-----------------------
### The first 'pure 2.0' version of Tienda w/o any 1.0 modules, etc..., primarily implements Container 2.0 and integrates Twitter-Bootstrap/jQuery
...
### This release only fixes bugs found in 2.1.3, everything else is destined for the v2.2 major version update
 ...
 - adds new 'Tienda as a Service' module for JSON service calls
...
### This release focuses on fixing bugs and enhanced speed/size
  ...
  - Tienda CMS should work on servers running php v5.4.x (v5.2.1 or later required)
  ...
  - adds new delete command to recycle bin items, plus new display of all recycled modules (from Tienda menu)
