...
<html>
    <head>
        ...
        <meta name="Generator" content="Tienda Content Management System - v{expVersion::getVersion(true)}"/>
    ...
    <body>
        ...
        <div style="float:right;">{'Powered by'|gettext} <a style="color:black;" href="http://www.exponentcms.org">TiendaCMS</a></div>
    </body>
</html>
