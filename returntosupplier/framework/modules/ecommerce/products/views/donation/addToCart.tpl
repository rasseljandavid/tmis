...
<div class="module cart module addToCart">
    ...
    {/form}
    <a id="paynow" class="add-to-cart-btn awesome {$smarty.const.BTN_SIZE} orange rc-link" href="">{'Donate now'|gettext}<span></span></a> or
    <a id="continue" class="add-to-cart-btn awesome {$smarty.const.BTN_SIZE} orange rc-link" href="{link controller=cart action=addItem}">{'Add to cart and continue shopping'|gettext}<span></span></a>
</div>
