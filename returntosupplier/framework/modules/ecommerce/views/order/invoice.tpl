...
<div id="invoice">
    <div id="store-header">
        <h2>{ecomconfig var=storename} {'Invoice'|gettext}</h2>
    ...
    <div id="invoice-data">
        ...
        <table class="special_instruction" border="0" cellspacing="0" cellpadding="0">
            <thead>
                <tr>
                    <th>
                    {"Delivery Date and Time"|gettext}
                    </th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr class="{cycle values="odd, even"}">
                    ...
                    <td>
						{permissions}
							...
							<a href="/product/{$oi->product->sef_url}">
							{/if}
						{/permissions}	
                        {$oi->getProductsName()} {$oi->product->capacity}
						{permissions}
							{if $permissions.manage == 1}
							</a>
							{/if}
