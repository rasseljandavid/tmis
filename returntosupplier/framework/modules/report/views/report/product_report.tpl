...
{form controller="report" action="generateProductReport" id="reportform" name="reportform"}
    <div id="create-prod-report" class="module report build-report yui-skin-sam">
        ...
        //                    });
                    ...
                    <tr class="odd">
                        <td>
                            <a id="submit-report" href="#" onclick="document.reportform.submit(); return false;" class="awesome {$smarty.const.BTN_SIZE} red"><strong><em>{'Generate Report'|gettext}</em></strong></a>
                        </td>
                    </tr>
                </tbody>
            </table>
