...
{if $success == 1}
    ...
    <a class="awesome {$smarty.const.BTN_SIZE} orange" href="{$smarty.const.URL_FULL}">{'Take me to my home page'|gettext}</a>
{else}
    ...
    <ol style="list-style:decimal;">
        <li>
            {'Download and extract the Tienda package corresponding to the \'from\' version in the upgrade notice above'|gettext}
            {br}
...
<a class="awesome {$smarty.const.BTN_SIZE} orange" href="{link controller=file action=import_files}">{'Import Files Archive'|gettext}</a>
