...
if (!defined('PATH_RELATIVE')) {
	if (isset($_SERVER['DOCUMENT_ROOT'])) {
		 ...
		 *
		 * The PATH_RELATIVE constant is the web path to the Tienda directory,
...
if (!defined('URL_BASE')) {
	 ...
	 * URL_BASE Constant
	 *
	 * The URL_BASE constant is the base URL of the domain hosting the Tienda site.
...
if (!defined('URL_BASE_SECURE')) {
     ...
     *
     * The URL_BASE_SECURE constant is the secure base URL of the domain hosting the Tienda site.
...
if (!defined('URL_FULL')) {
	 ...
	 * URL_FULL Constant
	 *
	 * The URL_FULL constant is the full URL path to the Tienda directory.  The automatic
	 * detection code can figure out if the server is running in SSL mode or not.
	 */
 ...
 */
define('EQL_HEADER','EQL-Tienda Query Language');
 ...
 *
 * An index for the Tienda Data Definition Language.
 ...
 *
 * A value for the Tienda Data Definition Language.
...
if (!defined('JS_RELATIVE')) {
	/** exdoc
     * The relative path to Tienda's core javascript.
	 */
...
//    define('JS_PATH',PATH_RELATIVE.'framework/core/assets/js/');  //TODO deprecated
    /** exdoc
   	 * The absolute url to Tienda's core javascript.
   	 */
...
if (!defined('YUI3_RELATIVE')) {
	 ...
	 * Changing the version here lets Tienda adjust where to look
	 */
