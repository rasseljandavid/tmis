...
class update_profile_paths extends upgradescript {
	 ...
	 * @return string
	 */
	function description() { return "Prior to v2.0.4, the User profile extension table contained full paths which prevented moving Tienda to a new folder after a test install.
