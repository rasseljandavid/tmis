...
if ($passed) {
	...
	$obj->installer_test = "Tienda Installer Wizard";
...
if ($passed) {
	...
	if ($obj == null || $obj->installer_test != "Tienda Installer Wizard") {
...
if ($passed) {
	...
	$obj = new stdClass();
	$obj->installer_test = "Tienda Installer ALTER test";
	$obj->exponent = "Tienda";
