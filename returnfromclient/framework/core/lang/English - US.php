...
return array(
	...
	"A link to a YouTube video.  YouTube takes precedence over an attached file."=>"A link to a YouTube video.  YouTube takes precedence over an attached file.",
	"A newer"=>"A newer",
	...
	"A strange internal error has occurred.  Please contact the Tienda Developers."=>"A strange internal error has occurred.  Please contact the Tienda Developers.",
	...
	"A table prefix may only contain numbers and letters.  Spaces and symbols (including \'_\') are not allowed.  An underscore will be added for you, by Tienda."=>"A table prefix may only contain numbers and letters.  Spaces and symbols (including \'_\') are not allowed.  An underscore will be added for you, by Tienda.",
	...
	"About"=>"About",
	"About TiendaCMS"=>"About TiendaCMS",
	"About Us"=>"About Us",
	...
	"Add and manage Tienda Files"=>"Add and manage Tienda Files",
	...
	"All database server software supported by Tienda require some sort of authentication.  Enter the name of the user account to use for logging into the database server."=>"All database server software supported by Tienda require some sort of authentication.  Enter the name of the user account to use for logging into the database server.",
	...
	"Attempting to Fix the Tienda Database"=>"Attempting to Fix the Tienda Database",
	"Attendees:"=>"Attendees:",
	...
	"Because of some of the functions that Tienda uses, versions of PHP prior to 5.2.1 are not suitable.  Most functions that are supported in later versions have workarounds, but there are a few major bugs, and functions that can\'t be re-implemented in PHP prior to 5.2.1."=>"Because of some of the functions that Tienda uses, versions of PHP prior to 5.2.1 are not suitable.  Most functions that are supported in later versions have workarounds, but there are a few major bugs, and functions that can\'t be re-implemented in PHP prior to 5.2.1.",
	...
	"Can increase paging speed, but may cause SEO issues"=>"Can increase paging speed, but may cause SEO issues",
	"Cancel"=>"Cancel",
	...
	"Custom E-Mail and View Record Template"=>"Custom E-Mail and View Record Template",
	"Custom E-Mail, Single and Multiple View Record Template"=>"Custom E-Mail, Single and Multiple View Record Template",
	...
	"DOMPDF is an optional package.  To obtain it, you must first download"=>"DOMPDF is an optional package.  To obtain it, you must first download",
	"Daily"=>"Daily",
	"Dark"=>"Dark",
	"Dashboard"=>"Dashboard",
	...
	"Download and extract the Tienda package corresponding to the \'from\' version in the upgrade notice above"=>"Download and extract the Tienda package corresponding to the \'from\' version in the upgrade notice above",
	...
	"Encapsulates other modules within a styled container (e.g. columns, tabs, etc...)"=>"Encapsulates other modules within a styled container (e.g. columns, tabs, etc...)",
	...
	"Tienda Base Controller"=>"Tienda Base Controller",
	"Tienda CMS : Install Wizard"=>"Tienda CMS : Install Wizard",
	"Tienda Documentation"=>"Tienda Documentation",
	"Tienda Install Wizard"=>"Tienda Install Wizard",
	"Tienda Lighthouse page"=>"Tienda Lighthouse page",
	"Tienda Smarty templates can be cached for speed, and the cached templates all go in the tmp/cache directory, which must be writable by the web server."=>"Tienda Smarty templates can be cached for speed, and the cached templates all go in the tmp/cache directory, which must be writable by the web server.",
	"Tienda Table Prefix"=>"Tienda Table Prefix",
	"Tienda Version"=>"Tienda Version",
	"Tienda as a Service"=>"Tienda as a Service",
	"Tienda can pull rss feeds into the news module and twitter feeds.  These pulled feeds are cached in the tmp/rsscache directory, which must be writable by the web server."=>"Tienda can pull rss feeds into the news module and twitter feeds.  These pulled feeds are cached in the tmp/rsscache directory, which must be writable by the web server.",
	"Tienda can use \'Minification\' for speed by compressing and compiling stylesheets in the tmp/minfy directory, which must be writable by the web server."=>"Tienda can use \'Minification\' for speed by compressing and compiling stylesheets in the tmp/minfy directory, which must be writable by the web server.",
	"Tienda creates image thumbnails \'on the fly\'.  These thumbnails are cached in the tmp/image_cache directory, which must be writable by the web server."=>"Tienda creates image thumbnails \'on the fly\'.  These thumbnails are cached in the tmp/image_cache directory, which must be writable by the web server.",
	"Tienda has deleted unneeded database columns from existing tables.  Shown below is a summary of the actions that occurred."=>"Tienda has deleted unneeded database columns from existing tables.  Shown below is a summary of the actions that occurred.",
	"Tienda has performed the following upgrades"=>"Tienda has performed the following upgrades",
	"Tienda includes the Pixidou image editor which can be used from the included File Manager.  Pixidou uses the tmp/pixidou directory for editing files, which must be writable by the web server."=>"Tienda includes the Pixidou image editor which can be used from the included File Manager.  Pixidou uses the tmp/pixidou directory for editing files, which must be writable by the web server.",
	"Tienda is currently updating existing tables in its database, and installing new tables that it needs.  Shown below is a summary of the actions that occurred."=>"Tienda is currently updating existing tables in its database, and installing new tables that it needs.  Shown below is a summary of the actions that occurred.",
	"Tienda is no longer minifying Javascript and CSS"=>"Tienda is no longer minifying Javascript and CSS",
	"Tienda is now checking to make sure that the database configuration information you provided is valid."=>"Tienda is now checking to make sure that the database configuration information you provided is valid.",
	"Tienda is now minifying Javascript and CSS"=>"Tienda is now minifying Javascript and CSS",
	"Tienda needs its own set of tables within a pre-existing database in order to function properly.  This can be accomplished by specifying a new table prefix."=>"Tienda needs its own set of tables within a pre-existing database in order to function properly.  This can be accomplished by specifying a new table prefix.",
	"Tienda requires a database to store and manage content."=>"Tienda requires a database to store and manage content.",
	"Tienda requires that several file permissions be set correctly in order to operate."=>"Tienda requires that several file permissions be set correctly in order to operate.",
	"Tienda runs a few checks against the installed (old-school) modules to make sure that nothing strange is encountered.  If this test fails, please Create a Ticket on the"=>"Tienda runs a few checks against the installed (old-school) modules to make sure that nothing strange is encountered.  If this test fails, please Create a Ticket on the",
	"Tienda runs a few checks against the installed modules to make sure that nothing strange is encountered.  If this test fails, please Create a Ticket on the"=>"Tienda runs a few checks against the installed modules to make sure that nothing strange is encountered.  If this test fails, please Create a Ticket on the",
	"Tienda stores all the content for your website in a relational database.  For portability reasons, a custom database abstraction layer is used.  Currently, this abstraction layer only supports MySQL.  If this test fails, then PHP support for these database engines was not detected."=>"Tienda stores all the content for your website in a relational database.  For portability reasons, a custom database abstraction layer is used.  Currently, this abstraction layer only supports MySQL.  If this test fails, then PHP support for these database engines was not detected.",
	"Tienda supports both the MySQL database server and the PostGreSQL database server as backends."=>"Tienda supports both the MySQL database server and the PostGreSQL database server as backends.",
	"Tienda uses Smarty to separate its data processing logic from its display logic.  Smarty templates are compiled from Smarty syntax into raw PHP for speed, and the compiled templates all go in the tmp/views_c directory, which must be writable by the web server."=>"Tienda uses Smarty to separate its data processing logic from its display logic.  Smarty templates are compiled from Smarty syntax into raw PHP for speed, and the compiled templates all go in the tmp/views_c directory, which must be writable by the web server.",
	"Tienda will perform the following upgrades"=>"Tienda will perform the following upgrades",
	"Tienda will prepend your table prefix with an underscore.  This improves database readability, and helps with troubleshooting."=>"Tienda will prepend your table prefix with an underscore.  This improves database readability, and helps with troubleshooting.",
	"Tienda works best when Open BaseDir is disabled"=>"Tienda works best when Open BaseDir is disabled",
	"Tienda works best when Safe Mode is disabled"=>"Tienda works best when Safe Mode is disabled",
	...
	"I want to transfer an existing Tienda v0.9x site"=>"I want to transfer an existing Tienda v0.9x site",
	"ID"=>"ID",
	"ID#"=>"ID#",
	...
	"If you decide to ignore this warning, make sure that ALL files included in the Tienda package are owned by the same system user."=>"If you decide to ignore this warning, make sure that ALL files included in the Tienda package are owned by the same system user.",
	...
	"If you have access to the database server, and have sufficient privileges to create databases, you can use the following SQL statements to setup the database for Tienda.  Note that you will have to fill in the form above before using these."=>"If you have access to the database server, and have sufficient privileges to create databases, you can use the following SQL statements to setup the database for Tienda.  Note that you will have to fill in the form above before using these.",
	...
	"If you upgrade any module in Tienda, these queries will be run to change table structures in the database."=>"If you upgrade any module in Tienda, these queries will be run to change table structures in the database.",
	...
	"Installing Tables adds any new fields to existing tables, and adds any additional tables Tienda needs to be awesome."=>"Installing Tables adds any new fields to existing tables, and adds any additional tables Tienda needs to be awesome.",
	...
	"Leave blank to display all fields.  Record fields are referenced within curly braces by"=>"Leave blank to display all fields.  Record fields are referenced within curly braces by",
	"Leave this custom definition blank to use the default \'all fields\' e-mail report and record view"=>"Leave this custom definition blank to use the default \'all fields\' e-mail report and record view",
	"Left"=>"Left",
	...
	"Manage Tienda CMS help files."=>"Manage Tienda CMS help files.",
	...
	"Manages all things about Tienda Modules"=>"Manages all things about Tienda Modules",
	"Managing"=>"Managing",
	...
	"Multi-Record View Configuration"=>"Multi-Record View Configuration",
	...
	"None of the installed Tienda Database Backends will work with this server\'s version of PHP."=>"None of the installed Tienda Database Backends will work with this server\'s version of PHP.",
	"Normal"=>"Normal",
	...
	"Note: this only properly copied over the records from the old database into the Tienda v2 database."=>"Note: this only properly copied over the records from the old database into the Tienda v2 database.",
	...
	"Patch Tienda CMS or Install Theme?"=>"Patch Tienda CMS or Install Theme?",
	...
	"Queries of this type are very important to the basic operation of Tienda.  All data stored in the database is read back through the use of SELECT queries."=>"Queries of this type are very important to the basic operation of Tienda.  All data stored in the database is read back through the use of SELECT queries.",
	"Query"=>"Query",
	"Question"=>"Question",
	"Quick Add"=>"Quick Add",
	...
	"Safe Mode is a security measure present in some Shared Hosting Environments.  It limits a PHP scripts from including or modifying files that are not owned by that script\'s owner.  This can cause serious and subtle problems that look like bugs if Tienda\'s files are not properly set up."=>"Safe Mode is a security measure present in some Shared Hosting Environments.  It limits a PHP scripts from including or modifying files that are not owned by that script\'s owner.  This can cause serious and subtle problems that look like bugs if Tienda\'s files are not properly set up.",
	"Sale"=>"Sale",
	...
	"Sample content was added to your database.  This content should help you learn how Tienda works, and how to use it for your website."=>"Sample content was added to your database.  This content should help you learn how Tienda works, and how to use it for your website.",
	...
	"Sanity checks are being run right now to ensure that the web server directory you wish to install Tienda in, is suitable."=>"Sanity checks are being run right now to ensure that the web server directory you wish to install Tienda in, is suitable.",
	"Sanity checks are being run right now to ensure that the web server directory you wish to upgrade Tienda in, is suitable."=>"Sanity checks are being run right now to ensure that the web server directory you wish to upgrade Tienda in, is suitable.",
	"Sat"=>"Sat",
	"Saturday"=>"Saturday",
	"Save"=>"Save",
	...
	"Select which database server software package your web server is running.  If the software is not listed, it is not supported by Tienda."=>"Select which database server software package your web server is running.  If the software is not listed, it is not supported by Tienda.",
	...
	"Server administrators have the option of disabling PHP uploads.  Additionally, misconfigured servers may have problems processing uploaded files.  Without the ability to upload files, your experience with Tienda will be severely limited, since you will be unable to upload new code, patches, or images and resources."=>"Server administrators have the option of disabling PHP uploads.  Additionally, misconfigured servers may have problems processing uploaded files.  Without the ability to upload files, your experience with Tienda will be severely limited, since you will be unable to upload new code, patches, or images and resources.",
	"Service"=>"Service",
	"Services"=>"Services",
	...
	"Showing all Blog Posts tagged as"=>"Showing all Blog Posts tagged as",
	...
	"Single-Record View Configuration"=>"Single-Record View Configuration",
	"Site"=>"Site",
	...
	"The Tienda Development Team would like to thank you for downloading and installing the Tienda Content Management System."=>"The Tienda Development Team would like to thank you for downloading and installing the Tienda Content Management System.",
	"The Tienda Install Wizard found no problems with the server environment."=>"The Tienda Install Wizard found no problems with the server environment.",
	"The Tienda Install Wizard found some major problems with the server environment, which you must fix before you can continue."=>"The Tienda Install Wizard found some major problems with the server environment, which you must fix before you can continue.",
	"The Tienda Install Wizard found some minor problems with the server environment, but you should be able to continue."=>"The Tienda Install Wizard found some minor problems with the server environment, but you should be able to continue.",
	"The Tienda Upgrade Wizard found no problems with the server environment."=>"The Tienda Upgrade Wizard found no problems with the server environment.",
	...
	"The install directory contains all of the files for the Tienda Install Wizard.  Once you have gone through the wizard once, it disables itself automatically (by removing the install/not_configured file).  To do this, it needs write permission on the install directory.  After installation, this directory isn\'t even needed, so you can remove it or set the permissions such that the web server cannot read it."=>"The install directory contains all of the files for the Tienda Install Wizard.  Once you have gone through the wizard once, it disables itself automatically (by removing the install/not_configured file).  To do this, it needs write permission on the install directory.  After installation, this directory isn\'t even needed, so you can remove it or set the permissions such that the web server cannot read it.",
	"The last Month"=>"The last Month",
	"The length of minification url"=>"The length of minification url",
	"The list of tables below are ones that are no longer used by Tienda. However, these tables probably"=>"The list of tables below are ones that are no longer used by Tienda. However, these tables probably",
	...
	"The sanity checks are in place to ensure that problems with the server environment (file permissions, PHP extensions, etc) are suitable for installing Tienda."=>"The sanity checks are in place to ensure that problems with the server environment (file permissions, PHP extensions, etc) are suitable for installing Tienda.",
	...
	"The tmp directory is used by various parts of Tienda for temporary files."=>"The tmp directory is used by various parts of Tienda for temporary files.",
	...
	"The web services extensions for Tienda require the Expat Library.  If you are not using web services or module that are dependent on web services, this is a safe warning to ignore."=>"The web services extensions for Tienda require the Expat Library.  If you are not using web services or module that are dependent on web services, this is a safe warning to ignore.",
	...
	"These queries create new table structures inside the database.  Tienda needs this when you install it for the first time.  CREATE TABLE queries are also run after new modules are uploaded to the site."=>"These queries create new table structures inside the database.  Tienda needs this when you install it for the first time.  CREATE TABLE queries are also run after new modules are uploaded to the site.",
	...
	"This Event Has Been Cancelled!"=>"This Event Has Been Cancelled!",
	"This Tienda Site has already been configured."=>"This Tienda Site has already been configured.",
	...
	"This installation wizard will guide you step by step through the configuration and setup of your new Tienda-powered website."=>"This installation wizard will guide you step by step through the configuration and setup of your new Tienda-powered website.",
	...
	"This is the base controller which most Tienda modules inherit their methods from."=>"This is the base controller which most Tienda modules inherit their methods from.",
	...
	"This is where you can configure the settings used by this Flowplayer module."=>"This is where you can configure the settings used by this Flowplayer module.",
	...
	"This is where you can configure the settings used by this YouTube module."=>"This is where you can configure the settings used by this YouTube module.",
	...
	"This is where you enter the database connection information for your old Tienda v1 site you want to migrate data from."=>"This is where you enter the database connection information for your old Tienda v1 site you want to migrate data from.",
	...
	"This module allows you make service calls and return JSON for parts of Tienda"=>"This module allows you make service calls and return JSON for parts of Tienda",
	...
	"This page allows you to manage help documents for Tienda CMS"=>"This page allows you to manage help documents for Tienda CMS",
	"This page allows you to manage versions for saving help documents for Tienda CMS"=>"This page allows you to manage versions for saving help documents for Tienda CMS",
	...
	"This version of TiendaCMS requires PHP 5.2.1 or higher. You are running PHP"=>"This version of TiendaCMS requires PHP 5.2.1 or higher. You are running PHP",
	...
	"This will set the default Language for the installation process as well as your new Tienda website."=>"This will set the default Language for the installation process as well as your new Tienda website.",
	"Thu"=>"Thu",
	...
	"Use this module to import and export data from your Tienda website."=>"Use this module to import and export data from your Tienda website.",
	...
	"Use this module to pull Tienda 1 style content from your old site."=>"Use this module to pull Tienda 1 style content from your old site.",
	...
	"We fervently hope that you will enjoy the power, flexibility, and ease-of-use that Tienda has to offer."=>"We fervently hope that you will enjoy the power, flexibility, and ease-of-use that Tienda has to offer.",
	...
	"Welcome to Tienda CMS"=>"Welcome to Tienda CMS",
	"What\'s this?"=>"What\'s this?",
	"When"=>"When",
	"When Tienda connects to the database, it needs to be able to run the following types of queries:"=>"When Tienda connects to the database, it needs to be able to run the following types of queries:",
	...
	"When content or configurations are updated, Tienda modifies the data in its tables by issuing UPDATE queries."=>"When content or configurations are updated, Tienda modifies the data in its tables by issuing UPDATE queries.",
	...
	"Whenever new content is added to the site, new permissions are assigned, users and/or groups are created and configuration data is saved, Tienda runs INSERT queries."=>"Whenever new content is added to the site, new permissions are assigned, users and/or groups are created and configuration data is saved, Tienda runs INSERT queries.",
	"White"=>"White",
	...
	"You can still check for an updated version using the Tienda, Super-Admin Tools menu"=>"You can still check for an updated version using the Tienda, Super-Admin Tools menu",
	...
	"Your version of Tienda CMS is current."=>"Your version of Tienda CMS is current.",
	"Youtube Settings"=>"Youtube Settings",
	"ZLib Support"=>"ZLib Support",
	"ZLib is used for archive support, which Tienda uses for uncompressing Tar and Zip archives."=>"ZLib is used for archive support, which Tienda uses for uncompressing Tar and Zip archives.",
	"Zip Code"=>"Zip Code",
	"Zip Code:"=>"Zip Code:",
	...
	"be obscured, because it cannot be obscured in the configuration file.  The Tienda developers urge you to use a completely new password, unlike any of your others, for security reasons."=>"be obscured, because it cannot be obscured in the configuration file.  The Tienda developers urge you to use a completely new password, unlike any of your others, for security reasons.",
	...
	"is not supported by Tienda"=>"is not supported by Tienda",
	"is used as the full path to the Tienda directory."=>"is used as the full path to the Tienda directory.",
	...
	"on your server with \'Patch Tienda CMS\' checked."=>"on your server with \'Patch Tienda CMS\' checked.",
	"only has"=>"only has",
	"or"=>"or",
	...
	"users and"=>"users and",
	"val"=>"val",
	"version of Tienda is available"=>"version of Tienda is available",
	"via"=>"via",
	"video"=>"video",
