...
{/css}
 ...
 <div class="form_header">
 	...
 	<blockquote>
 		{'Tienda is currently updating existing tables in its database, and installing new tables that it needs.  Shown below is a summary of the actions that occurred.'|gettext}
 	</blockquote>
 </div>
