			...
			<div id="tab4">
                ...
                <div>
                    ...
                    {form action=install_extension_confirm}
                        ...
                        {control type="checkbox" name="patch" label='Patch Tienda CMS or Install Theme?' value=1 description='All extensions are normally placed within the CURRENT theme (folder)'|gettext}
