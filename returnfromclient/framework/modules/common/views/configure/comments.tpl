...
<div class="form_header">
	<div class="info-header">
		<div class="related-actions">
		    {help text="Get Help with"|gettext|cat:" "|cat:("Comment Settings"|gettext) module="comments"}
		</div>
...
{control type=checkbox name=disable_item_comments label="Allow Disabling Comments Per-Item"|gettext value=1 checked=$config.disable_item_comments}
