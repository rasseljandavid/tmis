...
<div class="module report generate-report">
    ...
    {form id="batch" controller=report}
        <div class="actions-to-apply">
            ...
            <a href="javascript:document.getElementById('batch').submit();" class="button awesome {$smarty.const.BTN_SIZE} red exp-ecom-link"><strong><em>{'Apply Batch Action'|gettext}</em></strong></a>
        </div>
