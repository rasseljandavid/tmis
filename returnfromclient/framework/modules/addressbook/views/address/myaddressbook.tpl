...
<div class="module address myaddressbook">
    <h2>{$moduletitle|default:"My address book"|gettext}</h2>
    <p>
    ...
    <p>
        {icon class="btn btn-success  btn-primary btn-medium" action=edit text="Add New Address"|gettext}
    </p>
    ...
    <a class="awesome {$smarty.const.BTN_SIZE} red" href="{backlink}">{"Done"|gettext}</a>
</div>
