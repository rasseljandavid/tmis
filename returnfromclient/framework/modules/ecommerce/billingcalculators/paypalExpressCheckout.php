...
//        global $db, $user;
        ...
        if (!isset($params['token'])) {
            ...
            $data = array(
                ...
                'PWD'                                => $pwd,
                'SIGNATURE'                          => $sig,
				'LOGOIMG'                           => "http://tienda.ph/themes/bootstraptheme/images/logo.png",
				'BRANDNAME'                          => "tienda.ph",
//                'VERSION'           => '59.0',
                'VERSION'                            => '95.0',
//                'ReturnUrl' => $returnURL,
...
//                'PAYMENTREQUEST_0_CURRENCYCODE' => 'USD',  // currency code
                'PAYMENTREQUEST_0_CURRENCYCODE'      => "PHP", // currency code
...
//                $data['L_AMT' . $n]    = number_format(($order->orderitem[$n]->products_price_adjusted), 2, '.', '');
                $data['L_PAYMENTREQUEST_0_NAME' . $n] = strlen($order->orderitem[$n]->products_name) > 127 ? substr($order->orderitem[$n]->products_name, 0, 124) . "..." : $order->orderitem[$n]->products_name . ' ' .  $order->orderitem[$n]->product->capacity;
