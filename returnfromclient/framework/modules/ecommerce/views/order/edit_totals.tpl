    ...
    {form action=save_totals}
        ...
        * {'Keep in mind, if you edit, add, or remove order items, the order will automatically recalculate these totals.'|gettext} {br}
        ...
        <table width='60%'>
            ...
            <tr><td>
                {control type=text name=tax label="Tax" value=$order->tax filter=money}</td><td>* {'Total of tax for this order'|gettext}
            </td></tr>
            <tr><td>
                {control type=text name=shipping_total label="Shipping Total"|gettext value=$order->shipping_total filter=money}</td><td> * {'Total of shipping for this order.'|gettext}
            </td></tr>
            <tr><td>
                {control type=text name=surcharge_total label="Surcharge Total"|gettext value=$order->surcharge_total filter=money} </td><td>* {'Total of per-product shipping surcharges.'|gettext}
            </td></tr>
            <tr><td>
                ...
                {control type=text name=grand_total label="Grand Total"|gettext value=$order->grand_total filter=money}</td><td> * {'Grand total of the order'|gettext}
            </td></tr>
            <tr><td>
