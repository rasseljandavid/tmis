...
<div class="module store show giftcards">
	...
	{form id="addtocart" controller=cart action=addItem}
        ...
        <a id="submit-giftcard" href="javascript:{ldelim}{rdelim}" class="awesome red {$smarty.const.BTN_SIZE} exp-ecom-link" rel="nofollow"><strong><em>{'Add selected items to cart'|gettext}</em></strong></a>
	{/form}
</div>
