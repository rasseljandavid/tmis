...
<div class="billing-method">
    ...
    {form name="passthruform" controller=cart action=preprocess}
        ...
        <a class="awesome {$smarty.const.BTN_SIZE} orange" href="#" id="continue-passthru-checkout" class="exp-ecom-link"><strong><em>{'Continue To Last Step'|gettext}</em></strong></a>
        <button id="continue-passthru-checkout" type="submit" class="add-to-cart-btn awesome {$smarty.const.BTN_SIZE} orange">{"Continue Checkout"|gettext}</button>
    {/form}
