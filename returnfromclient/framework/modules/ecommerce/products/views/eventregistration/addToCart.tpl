...
{if $product->isAvailable()}
    <div class="module cart eventregistration addToCart">
        ...
        {form name="evregfrm" action=addItem}
            ...
            <a class="exp-ecom-link plus addtocart add-to-cart-btn awesome {$smarty.const.BTN_SIZE} orange rc-link" id="newregistrant" href="#"><em>{'Add another registrant'|gettext}</em> <span></span></a>
            &#160;&#160; {'OR'|gettext} &#160;
            <a class="exp-ecom-link addtocart add-to-cart-btn awesome {$smarty.const.BTN_SIZE} orange rc-link" onclick="EXPONENT.validateReg()" href="#"><em>{'Add Registration to Cart'|gettext}</em><span></span></a>
        {/form}
    </div>
