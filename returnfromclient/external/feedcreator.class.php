...
define("FEEDCREATOR_VERSION", 'Tienda Content Management System - '.expVersion::getVersion(true,true));
...
class Podcast {
     ...
     *
     * @param \PodcastCategory $category The PodcastCategory to add to the podcast
     *
     * @access public
     */
    function addCategory($category) {
