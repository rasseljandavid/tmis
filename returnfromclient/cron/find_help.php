...
/**
 * find_help.php - attempts to auto-check all TiendaCMS help links
 * by collecting them and checking them against the doc.exponentcms.org db tables
 */
print $nl . "Checking the Tienda Help System!" . $nl . $nl;
...
print $nl . "Completed Checking the Tienda Help System!" . $nl;
